<?php
namespace AestheticaSpace\Kits;

use AestheticaSpace\Kits\Classes;
use AestheticaSpace\Kits\Controls\Controls_Manager;
...
class Module extends ElementorBaseModule {
	...
	public function enqueue_scripts() {
		if ( ! class_exists( 'Cmsmasters_Elementor_Addon' ) ) {
			...
			wp_enqueue_script(
				'aesthetica-elementor-kits-controls',
