<?php
namespace AestheticaSpace\Kits\Settings\Footer;
...
class Footer extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer', 'aesthetica' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'alignment',
			array(
				'label' => esc_html__( 'Alignment', 'aesthetica' ),
				'label_block' => false,
				'type' => Controls_Manager::CHOOSE,
				'options' => array(
					'center' => array(
					...
					'space-between' => array(
						'title' => esc_html__( 'Justified', 'aesthetica' ),
