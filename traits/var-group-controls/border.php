<?php
namespace AestheticaSpace\Kits\Traits\VarGroupControls;
	...
	protected function var_group_control_border( $key = '', $args = array() ) {
		...
		$default_args = array(
			...
			'fields_options' => array(
				'border' => array(
					'options' => array(
						'' => _x( 'Default', 'Border Control', 'aesthetica' ),
						'none' => _x( 'None', 'Border Control', 'aesthetica' ),
						'solid' => _x( 'Solid', 'Border Control', 'aesthetica' ),
						'double' => _x( 'Double', 'Border Control', 'aesthetica' ),
						'dotted' => _x( 'Dotted', 'Border Control', 'aesthetica' ),
						'dashed' => _x( 'Dashed', 'Border Control', 'aesthetica' ),
						'groove' => _x( 'Groove', 'Border Control', 'aesthetica' ),
					),
					'selectors' => array(
