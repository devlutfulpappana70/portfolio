	...
	protected function controls_group_post_meta( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Elements', 'aesthetica' ),
					'label_block' => true,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
					'type' => CmsmastersControls::SELECTIZE,
					'options' => array(
						'categories' => esc_html__( 'Categories', 'aesthetica' ),
						'author' => esc_html__( 'Author', 'aesthetica' ),
						'date' => esc_html__( 'Date', 'aesthetica' ),
						'comments' => esc_html__( 'Comments', 'aesthetica' ),
						'tags' => esc_html__( 'Tags', 'aesthetica' ),
					),
					'multiple' => true,
		...
		$color_controls = array(
			'colors_text' => esc_html__( 'Text', 'aesthetica' ),
			'colors_link' => esc_html__( 'Link', 'aesthetica' ),
			'colors_hover' => esc_html__( 'Link Hover', 'aesthetica' ),
		);
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						...
						'block' => esc_html__( 'Show', 'aesthetica' ),
					),
					'selectors' => array(
