	...
	protected function controls_group_quotes( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Cite', 'aesthetica' ),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before',
				)
			)
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'separator' => 'before',
					'options' => array(
						'none' => esc_html__( 'Hide', 'aesthetica' ),
						'flex' => esc_html__( 'Show', 'aesthetica' ),
					),
					'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Offset', 'aesthetica' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => array(
						'px',
					),
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Vertical Offset', 'aesthetica' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => array(
						'px',
					),
