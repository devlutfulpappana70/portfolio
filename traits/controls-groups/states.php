		...
		if ( $heading ) {
			$this->add_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'States', 'aesthetica' ),
		...
		foreach ( $states as $state_key => $state_label ) {
			...
			if ( 'gradient' === $background ) {
				$this->add_control(
					...
					array(
						'label' => _x( 'Background Type', 'Background Control', 'aesthetica' ),
						'type' => Controls_Manager::CHOOSE,
						'options' => array(
							'classic' => array(
								'title' => _x( 'Classic', 'Background Control', 'aesthetica' ),
								'icon' => 'eicon-paint-brush',
							),
							'gradient' => array(
								'title' => _x( 'Gradient', 'Background Control', 'aesthetica' ),
								'icon' => 'eicon-barcode',
							),
						),
						'default' => 'classic',
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Background', 'Background Control', 'aesthetica' ),
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Background Location', 'Background Control', 'aesthetica' ),
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Second Background', 'Background Control', 'aesthetica' ),
						'type' => Controls_Manager::COLOR,
						'dynamic' => array(),
						'render_type' => 'ui',
						'condition' => array(
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Second Background Location', 'Background Control', 'aesthetica' ),
						'type' => Controls_Manager::SLIDER,
						'size_units' => array( '%' ),
						'default' => array(
							'unit' => '%',
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Type', 'Background Control', 'aesthetica' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'linear' => _x( 'Linear', 'Background Control', 'aesthetica' ),
							'radial' => _x( 'Radial', 'Background Control', 'aesthetica' ),
						),
						'default' => 'linear',
						'render_type' => 'ui',
						'condition' => array(
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Angle', 'Background Control', 'aesthetica' ),
						'type' => Controls_Manager::SLIDER,
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Position', 'Background Control', 'aesthetica' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'center center' => _x( 'Center Center', 'Background Control', 'aesthetica' ),
							'center left' => _x( 'Center Left', 'Background Control', 'aesthetica' ),
							'center right' => _x( 'Center Right', 'Background Control', 'aesthetica' ),
							'top center' => _x( 'Top Center', 'Background Control', 'aesthetica' ),
							'top left' => _x( 'Top Left', 'Background Control', 'aesthetica' ),
							'top right' => _x( 'Top Right', 'Background Control', 'aesthetica' ),
							'bottom center' => _x( 'Bottom Center', 'Background Control', 'aesthetica' ),
							'bottom left' => _x( 'Bottom Left', 'Background Control', 'aesthetica' ),
							'bottom right' => _x( 'Bottom Right', 'Background Control', 'aesthetica' ),
						),
				...
				$this->add_control(
					$this->get_control_name_parameter( $key, "{$state_key}_colors_bg" ),
					array(
						'label' => esc_html__( 'Background', 'aesthetica' ),
						'type' => Controls_Manager::COLOR,
						'dynamic' => array(),
						'selectors' => array(
							':root' => '--' . $this->get_control_prefix_parameter( $key, "{$state_key}_colors_bg" ) . ': {{VALUE}};',
			...
			if ( true === $border ) {
				$this->add_control(
					...
					array(
						'label' => esc_html__( 'Border', 'aesthetica' ),
						'type' => Controls_Manager::COLOR,
						'dynamic' => array(),
						'selectors' => array(
			...
			if ( true === $bd_radius ) {
				$this->add_control(
					...
					array(
						'label' => esc_html__( 'Border Radius', 'aesthetica' ),
			...
			if (
				...
				$this->add_control(
					...
					array(
						'label' => esc_html__( 'Text Decoration', 'aesthetica' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'' => esc_html__( 'Default', 'aesthetica' ),
							'none' => _x( 'None', 'Typography Control', 'aesthetica' ),
							'underline' => _x( 'Underline', 'Typography Control', 'aesthetica' ),
							'overline' => _x( 'Overline', 'Typography Control', 'aesthetica' ),
							'line-through' => _x( 'Line Through', 'Typography Control', 'aesthetica' ),
						),
						'selectors' => array(
			...
			$this->add_var_group_control(
				...
				array(
					'fields_options' => array(
						'width' => array( 'label' => esc_html__( 'Border Width', 'aesthetica' ) ),
					),
					'exclude' => array( 'color' ),
					'separator' => 'before',
				)
