<?php
namespace AestheticaSpace\Kits\Settings\LazyloadWidget;
...
class Preloader extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Preloader', 'aesthetica' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'icon_color',
			array(
				'label' => esc_html__( 'Icon Color', 'aesthetica' ),
		...
		$this->add_control(
			'icon_animation_type',
			array(
				'label' => __( 'Icon Animation Type', 'aesthetica' ),
				'label_block' => false,
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'none' => __( 'None', 'aesthetica' ),
					'lazyLoadWidgetBlink' => __( 'Blink', 'aesthetica' ),
					'lazyLoadWidgetSpinner' => __( 'Spin', 'aesthetica' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Icon Animation Speed', 'aesthetica' ) . ' (ms)',
		...
		$this->add_var_group_control( 'overlay', self::VAR_BACKGROUND, array(
			'fields_options' => array(
				'background' => array(
					'label' => esc_html_x( 'Overlay Background Type', 'Background Control', 'aesthetica' ),
				),
			),
			'separator' => 'before',
		) );
		...
		$this->add_var_group_control( '', self::VAR_BORDER, array(
			'fields_options' => array(
				'width' => array(
					'label' => esc_html__( 'Border Width', 'aesthetica' ),
				),
				'color' => array(
					'label' => esc_html__( 'Border Color', 'aesthetica' ),
					'condition' => array(
						'border!' => array(
							'',
							'none',
