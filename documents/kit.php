<?php
namespace AestheticaSpace\Kits\Documents;

use AestheticaSpace\Kits\Module as KitsModule;
...
class Kit extends BaseKit {
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, array(
			'i18n' => array(
				'cmsmasters_theme' => esc_html__( 'Theme Settings', 'aesthetica' ),
				'design_system' => esc_html__( 'Design System', 'aesthetica' ),
				'theme_style' => esc_html__( 'Theme Style', 'aesthetica' ),
				'settings' => esc_html__( 'Settings', 'aesthetica' ),
				'additional_settings' => esc_html__( 'Additional Settings', 'aesthetica' ),
			),
		) );
