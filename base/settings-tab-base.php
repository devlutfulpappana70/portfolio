<?php
namespace AestheticaSpace\Kits\Settings\Base;

use AestheticaSpace\Kits\Traits\Base as KitBaseTraits;
...
abstract class Settings_Tab_Base extends Tab_Base {
	...
	public function get_default_setting( $key, $default = false ) {
		$settings = get_option( 'cmsmasters_aesthetica_default_kits', array() );
