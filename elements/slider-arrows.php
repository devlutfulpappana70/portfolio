...
class Slider_Arrows extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider Arrows', 'aesthetica' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: more posts, single post gallery, archive post gallery.', 'aesthetica' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'always' => esc_html__( 'Always', 'aesthetica' ),
					'hover' => esc_html__( 'On Hover', 'aesthetica' ),
				),
				'toggle' => false,
		...
		foreach ( array(
			'prev' => esc_html__( 'Previous', 'aesthetica' ),
			'next' => esc_html__( 'Next', 'aesthetica' ),
		) as $key => $label ) {
			$is_prev = 'prev' === $key;
			...
			$this->add_control(
				"{$key}_icon_position",
				array(
					'label' => esc_html__( 'Icon Position', 'aesthetica' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
					'type' => Controls_Manager::SELECT,
					'options' => array(
						'before' => esc_html__( 'Before', 'aesthetica' ),
						'after' => esc_html__( 'After', 'aesthetica' ),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			'text_direction',
			array(
				'label' => esc_html__( 'Text Direction', 'aesthetica' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'horizontal' => esc_html__( 'Horizontal', 'aesthetica' ),
					'vertical' => esc_html__( 'Vertical', 'aesthetica' ),
				),
				'default' => $this->get_default_setting(
		...
		foreach ( array(
			'normal' => esc_html__( 'Normal', 'aesthetica' ),
			'hover' => esc_html__( 'Hover', 'aesthetica' ),
		) as $key => $label ) {
			$this->start_controls_tab(
				"states_{$key}_tab",
				array( 'label' => $label )
		...
		$this->add_responsive_control(
			'icon_size',
			array(
				'label' => esc_html__( 'Icon Size', 'aesthetica' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'spacing',
			array(
				'label' => esc_html__( 'Arrows Spacing', 'aesthetica' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_responsive_control(
			'box_width',
			array(
				'label' => esc_html__( 'Arrows Box Width', 'aesthetica' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'box_height',
			array(
				'label' => esc_html__( 'Arrows Box Height', 'aesthetica' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'icon_gap',
			array(
				'label' => esc_html__( 'Icon Gap', 'aesthetica' ),
				'description' => esc_html__( 'Gap Between Icon and Text', 'aesthetica' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'max' => 50,
		...
		$this->add_responsive_control(
			'padding',
			array(
				'label' => esc_html__( 'Padding', 'aesthetica' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Text On Tablet/Mobile', 'aesthetica' ),
				'label_block' => false,
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
					'flex' => array(
						'title' => esc_html__( 'Show', 'aesthetica' ),
					),
					'none' => array(
						'title' => esc_html__( 'Hide', 'aesthetica' ),
					),
				),
				'toggle' => true,
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Container', 'aesthetica' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'row' => array(
						'title' => esc_html__( 'Horizontal', 'aesthetica' ),
						'icon' => 'eicon-navigation-horizontal',
					),
					'column' => array(
						'title' => esc_html__( 'Vertical', 'aesthetica' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Horizontal Alignment', 'aesthetica' ),
				'label_block' => false,
				'type' => Controls_Manager::CHOOSE,
				'options' => array(
					'flex-start' => array(
						'title' => esc_html__( 'Start', 'aesthetica' ),
					...
					'flex-end' => array(
						'title' => esc_html__( 'End', 'aesthetica' ),
						'icon' => 'eicon-h-align-right',
					),
					'space-between' => array(
						'title' => esc_html__( 'Space Between', 'aesthetica' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options' => array(
					...
					'center' => array(
						'title' => esc_html__( 'Middle', 'aesthetica' ),
		...
		$this->add_responsive_control(
			'container_margin',
			array(
				'label' => esc_html__( 'Margin', 'aesthetica' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px' ),
				'selectors' => array(
