<?php
namespace AestheticaSpace\Kits\Settings\FooterWidgets;
...
class Footer_Widgets extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer Widgets', 'aesthetica' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( "If you use a 'Footer' template, then the settings will not be applied, if you set the template to sitewide, then these settings will be hidden.", 'aesthetica' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'show' => esc_html__( 'Show On All Devices', 'aesthetica' ),
					'hide_tablet' => esc_html__( 'Hide On Tablet And Less', 'aesthetica' ),
					'hide_mobile' => esc_html__( 'Hide On Mobile', 'aesthetica' ),
					'hide' => esc_html__( 'Hide On All Devices', 'aesthetica' ),
				),
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Desktop', 'aesthetica' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label_block' => true,
				'show_label' => false,
				'raw' => esc_html__( 'Layout for this columns count will be', 'aesthetica' ) . '<br />1/5 + 1/5 + 1/5 + 1/5 + 1/5',
				'type' => Controls_Manager::RAW_HTML,
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Tablet', 'aesthetica' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Columns in Row', 'aesthetica' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Reverse Columns', 'aesthetica' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'aesthetica' ),
				'label_on' => esc_html__( 'Yes', 'aesthetica' ),
				'default' => $this->get_default_setting(
		...
		$this->add_control(
			'tablet_hide_1',
			array(
				'label' => esc_html__( 'Hide "Footer 1" widgets area', 'aesthetica' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'aesthetica' ),
				'label_on' => esc_html__( 'Yes', 'aesthetica' ),
		...
		$this->add_control(
			'tablet_hide_2',
			array(
				'label' => esc_html__( 'Hide "Footer 2" widgets area', 'aesthetica' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'aesthetica' ),
				'label_on' => esc_html__( 'Yes', 'aesthetica' ),
		...
		$this->add_control(
			'tablet_hide_3',
			array(
				'label' => esc_html__( 'Hide "Footer 3" widgets area', 'aesthetica' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'aesthetica' ),
				'label_on' => esc_html__( 'Yes', 'aesthetica' ),
		...
		$this->add_control(
			'tablet_hide_4',
			array(
				'label' => esc_html__( 'Hide "Footer 4" widgets area', 'aesthetica' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'aesthetica' ),
				'label_on' => esc_html__( 'Yes', 'aesthetica' ),
		...
		$this->add_control(
			'tablet_hide_5',
			array(
				'label' => esc_html__( 'Hide "Footer 5" widgets area', 'aesthetica' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'aesthetica' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'aesthetica' ),
				'label_on' => esc_html__( 'Yes', 'aesthetica' ),
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Mobile', 'aesthetica' ),
			)
		);
		...
		$this->add_responsive_control(
			'columns_gap',
			array(
				'label' => esc_html__( 'Columns Gap', 'aesthetica' ),
		...
		$this->add_responsive_control(
			'widgets_gap',
			array(
				'label' => esc_html__( 'Widgets Gap Between', 'aesthetica' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
