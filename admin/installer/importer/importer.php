...
use AestheticaSpace\Admin\Installer\Importer\ACF;
use AestheticaSpace\Admin\Installer\Importer\CPTUI;
use AestheticaSpace\Admin\Installer\Importer\Elementor_Fonts;
use AestheticaSpace\Admin\Installer\Importer\Elementor_Icons;
use AestheticaSpace\Admin\Installer\Importer\Elementor_Importer;
use AestheticaSpace\Admin\Installer\Importer\Elementor_Kit;
use AestheticaSpace\Admin\Installer\Importer\Elementor_Templates;
use AestheticaSpace\Admin\Installer\Importer\Theme_Options;
use AestheticaSpace\Admin\Installer\Importer\WPForms;
use AestheticaSpace\Admin\Installer\Importer\Forminator;
use AestheticaSpace\Admin\Installer\Importer\Give_WP;
use AestheticaSpace\Admin\Installer\Importer\WPRM_Templates;
use AestheticaSpace\Admin\Installer\Importer\Woo_Product_Filter;
use AestheticaSpace\Admin\Installer\Importer\Revslider;
use AestheticaSpace\Admin\Installer\Importer\WPClever_Smart_Compare;
use AestheticaSpace\Admin\Installer\Importer\WPClever_Smart_Quick_View;
use AestheticaSpace\Admin\Installer\Importer\WPClever_Smart_Wishlist;
use AestheticaSpace\Admin\Installer\Importer\WPClever_Variation_Swatches;
...
class Importer {
	...
	public function set_import_attachments_ids( $post_id, $original_id, $postdata, $data ) {
		...
		$attachments_ids = get_option( "cmsmasters_aesthetica_{$demo}_import_attachments_ids" );
		...
		update_option( "cmsmasters_aesthetica_{$demo}_import_attachments_ids", $attachments_ids, false );
	}
	...
	public function set_import_posts_ids( $post_id, $original_id, $postdata, $post ) {
		...
		$displayed_ids = get_option( "cmsmasters_aesthetica_{$demo}_import_displayed_ids", array() );

		$displayed_ids['post_id'][ $post['post_type'] ][ $original_id ] = $post_id;

		update_option( "cmsmasters_aesthetica_{$demo}_import_displayed_ids", $displayed_ids, false );
	}
	...
	public function set_import_terms_ids( $term_id, $data ) {
		...
		$displayed_ids = get_option( "cmsmasters_aesthetica_{$demo}_import_displayed_ids" );
	...
	public function remove_import_temp_options() {
		...
		if ( 'imported' !== get_option( "cmsmasters_aesthetica_{$demo}_content_import_status" ) ) {
			return;
		}

		delete_option( "cmsmasters_aesthetica_{$demo}_elementor_import_templates_ids" );
		delete_option( "cmsmasters_aesthetica_{$demo}_import_attachments_ids" );
		delete_option( "cmsmasters_aesthetica_{$demo}_import_displayed_ids" );
	}
