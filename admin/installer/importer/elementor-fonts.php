...
class Elementor_Fonts {
	...
	public static function set_import_status( $status = 'pending' ) {
		...
		if ( 'done' === get_option( "cmsmasters_aesthetica_{$demo}_elementor_fonts_import" ) ) {
			return;
		}

		update_option( "cmsmasters_aesthetica_{$demo}_elementor_fonts_import", $status );
	}
	...
	public function get_local_fonts() {
		...
		if ( 'pending' !== get_option( "cmsmasters_aesthetica_{$demo}_elementor_fonts_import", 'done' ) ) {
			return;
		}

		$data = API_Requests::post_request( 'get-elementor-fonts', array( 'demo' => Utils::get_demo() ) );
		...
		update_option( "cmsmasters_aesthetica_{$demo}_elementor_fonts_import", 'done' );
	}
