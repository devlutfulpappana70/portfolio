...
class Utils {
	...
	public static function get_demo() {
		if ( ! self::$demo_key ) {
			self::$demo_key = get_option( 'cmsmasters_aesthetica_demo', 'main' );
		}
	...
	public static function set_demo( $demo_key ) {
		update_option( 'cmsmasters_aesthetica_demo', $demo_key );
	...
	public static function get_demo_kit() {
		if ( ! self::$demo_kit_key ) {
			self::$demo_kit_key = get_option( 'cmsmasters_aesthetica_demo_kit', 'main' );
		}
	...
	public static function set_demo_kit( $demo_kit_key ) {
		update_option( 'cmsmasters_aesthetica_demo_kit', $demo_kit_key );
	...
	public static function get_theme_options() {
		return get_option( 'cmsmasters_aesthetica_options', array() );
	}
	...
	public static function get_default_kits() {
		if ( ! self::$default_kits ) {
			self::$default_kits = get_option( 'cmsmasters_aesthetica_default_kits', array() );
		}
